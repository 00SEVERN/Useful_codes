# -*- coding: utf-8 -*-
"""
Created on Thu Jan  9 14:22:11 2020
...
train_data, valid_data, test_data = Multi30k.splits(exts = ('.ces', '.hum'), fields = (SRC, TRG), path = ('L://Knowledge Management/_KM (Secure)/Inspec/Inspec2/Inspec 2 Development/CCtoCC/Split/'))
...
torch.save(model.state_dict(), 'CCtoCC1.pt')
